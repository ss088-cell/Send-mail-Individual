      ...
      const emailBody = `
        ...
        <div style="max-width: 400px; text-align: left;">
          <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
            <tr>
              <th style="background-color: #f0f8ff; padding: 8px; font-size: 14px;">Severity</th>
              <th style="background-color: #f0f8ff; padding: 8px; font-size: 14px;">Remediation Time</th>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 8px; font-size: 14px;">Critical</td>
              <td style="border: 1px solid black; padding: 8px; font-size: 14px;">30 days</td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 8px; font-size: 14px;">High</td>
              <td style="border: 1px solid black; padding: 8px; font-size: 14px;">60 days</td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 8px; font-size: 14px;">Medium</td>
              <td style="border: 1px solid black; padding: 8px; font-size: 14px;">90 days</td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 8px; font-size: 14px;">Low</td>
              <td style="border: 1px solid black; padding: 8px; font-size: 14px;">120 days</td>
            </tr>
          </table>
        </div><br><br>
