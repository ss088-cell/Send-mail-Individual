...
function fetchEmailDetails(sheetUrl) {
  ...
  for (let i = 1; i < data.length; i++) {
    if (data[i][0] === appName) {
      ...
      const sheetName = recipientSpreadsheet.getName(); // Get the full sheet name
      const emailBody = `
        Hi Team,<br><br>
        ...
        Direct Report Link: <a href="${sheetUrl}">${sheetName} Report</a><br><br>
        ...
        <div style="max-width: 600px; margin: auto;"> <!-- Limit table width -->
          <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
            <tr>
              ...
              <th style="background-color: lightblue; padding: 8px;">Remediation Time</th>
            </tr>
            <tr>
