    ...
    for (let i = 1; i < data.length; i++) {
        if (data[i][0] === appName) {
            ...
            const emailBody = `
                ...
                <div style="max-width: 600px; margin: auto; text-align: left;"> <!-- Limit table width and align left -->
                  <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
                    <tr>
                      <th style="background-color: #e0f7fa; padding: 6px; font-size: 12px;">Severity</th>
                      <th style="background-color: #e0f7fa; padding: 6px; font-size: 12px;">Remediation Time</th>
                    </tr>
                    <tr>
                      <td style="border: 1px solid black; padding: 6px; font-size: 12px;">Critical</td>
                      <td style="border: 1px solid black; padding: 6px; font-size: 12px;">30 days</td>
                    </tr>
                    <tr>
                      <td style="border: 1px solid black; padding: 6px; font-size: 12px;">High</td>
                      <td style="border: 1px solid black; padding: 6px; font-size: 12px;">60 days</td>
                    </tr>
                    <tr>
                      <td style="border: 1px solid black; padding: 6px; font-size: 12px;">Medium</td>
                      <td style="border: 1px solid black; padding: 6px; font-size: 12px;">90 days</td>
                    </tr>
                    <tr>
                      <td style="border: 1px solid black; padding: 6px; font-size: 12px;">Low</td>
                      <td style="border: 1px solid black; padding: 6px; font-size: 12px;">120 days</td>
                    </tr>
                  </table>
                </div><br><br>
